    ...
    public List<EntidadeDominio> consultar(EntidadeDominio entidade) {
        ...
        if (bandeira.getBandeira() != null) {
            return List.of(entityManager
                    .createQuery("select b from Bandeira b where b.bandeira = :bandeira", Bandeira.class)
                    .setParameter("bandeira", bandeira.getBandeira())
                    .getSingleResult());
        }

        List<Bandeira> res = entityManager
                .createQuery("select b from Bandeira b order by bandeira", Bandeira.class)
                .getResultList();
