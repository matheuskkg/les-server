...
public class SenhaDAO implements IDAO {
	...
	private void alterarSenha(Senha senha) {
		entityManager.createQuery("""
				...
				""").setParameter("novaSenha", senha.getSenha()).setParameter("id", senha.getId()).executeUpdate();
	}
	...
	private Senha buscarPorCliente(Senha senha) {
		return entityManager.createQuery("""
				...
				""", Senha.class).setParameter("clienteId", senha.getCliente().getId()).getSingleResult();
	}
