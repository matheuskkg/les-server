...
public interface BandeiraRepository extends JpaRepository<Bandeira, Integer> {
    ...
    @Query("select new mkkg.fatec.esiii.domain.cartao.BandeiraResponseDTO(b.id, b.bandeira) from Bandeira b order by b.bandeira")
    List<BandeiraResponseDTO> findAllOrderByBandeira();
